              ...
              i === currentIndex && (
                ...
                >
                  ...
                  <motion.div
                    ...
                    className="z-30 w-[90%] md:w-[50%] lg:w-[35%] absolute top-1/2 text-white left-1/2 -translate-x-1/2"
                  >
                    <p className="overflow-hidden flex flex-wrap gap-1 text-xl md:text-2xl">
